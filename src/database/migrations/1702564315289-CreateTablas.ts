...
export class CreateTablas1702564315289 implements MigrationInterface {
    name = 'CreateTablas1702564315289'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "name" character varying NOT NULL, "teacherId" uuid, CONSTRAINT "REL_d841b74fd2e92061b15c20d4ea" UNIQUE ("teacherId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
