...
export class CreateTables1701432237199 implements MigrationInterface {
    name = 'CreateTables1701432237199'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."lesson_task_enum" AS ENUM('No', 'Pendiente', 'Corregida')`);
